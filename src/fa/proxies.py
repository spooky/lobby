...
class proxies(QtCore.QObject):
    ...
    def __init__(self, parent=None):
        ...
        if errored:
            QMessageBox.warning(self.client, "Cannot use proxy server", "FAF is unable to bind the port <b>12000 to 12011 on TCP</b>.<br>Please check your firewall settings.<br><b>You may experience connections problems until it's fixed.</b>")
