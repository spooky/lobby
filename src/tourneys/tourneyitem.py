...
class TourneyItemDelegate(QStyledItemDelegate):
    ...
    def paint(self, painter, option, index, *args, **kwargs):
        ...
        #painter.fillRect(QtCore.QRect(0, 0, option.rect.width(), option.rect.height()), QColor(36, 61, 75, 150))
...
class TourneyItem(QListWidgetItem):
    ...
    def update(self, message, client):
        ...
        for player in self.players :
            ...
            if old_state != self.state and self.state == "started" and player["name"] == self.client.login :
                ...
                QMessageBox.information(self.client, "Tournament started !", "Your tournament has started !\nYou have automatically joined the tournament channel.")
