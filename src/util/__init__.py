        ...
        if os.path.isdir(test_dir):
            ...
            if developer() or os.path.isfile(version_file) and (VERSION_STRING == open(version_file).read()):
                ...
                result = QMessageBox.question(QApplication.activeWindow(), "Incompatible Theme",
                                              "The following theme is not the right version:<br/><b>" + theme + "</b><br/><i>Contact the maker of the theme for an update!</i><br/><br/>"
                                              "<b>Reset to default, or apply theme anyway?</b>",
